...
class TestReview_instantiation(unittest.TestCase):
    """Unittests for testing if the instantiation of the Review class works as intended."""
...
class TestReview_save(unittest.TestCase):
    """Testing if the save method of the Review class works."""
...
class TestReview_to_dict(unittest.TestCase):
    """Unittests for to_dict method of the Review class test."""
